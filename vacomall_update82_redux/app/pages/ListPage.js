...
class ListPage extends Component {
    ...
    getListData() {
        ...
        if (this.props.id === null) {
            ...
            NetService.postFetchData(API.LIST, 'cid=' + this.props.id + '&page=' + this.state.page + '&size=' + this.state.size + '&sort=' + this.state.sort, (result)=>this._callback(result));
        }
...
function select(store) {
    return{
        id:store.routeStore.id,
        text:store.routeStore.text,
    }
}
