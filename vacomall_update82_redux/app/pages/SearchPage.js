...
import {TO_NEXT_TYPE30} from '../actions/route';
...
export default class SearchPage extends Component {
    ...
    componentDidMount() {
        ...
        if(searchText!==undefined){
            this.setState({
                text:searchText,
                clear: <TouchableWithoutFeedback  thoutFeedback onPress={()=>this._clear()}>
    ...
    _onSubmit() {
        ...
        this.toListPage(this.state.text);
    }
